...
// Load properties from SpringBoot known default location.
// We avoid loading the complete application context.
// But we are coupling the test to the location of the application.properties file
@TestPropertySource(
...
public class ConfigPropertiesTest2 {
